  ...
  changelogs: [
    {
      ...
      'changelog': {
        'new': [
          'Added new Angular <code>demo4</code>. <a href="https://preview.keenthemes.com/metronic8/angular/demo4">Preview</a>',
          'Added new Angular <code>demo6</code>. <a href="https://preview.keenthemes.com/metronic8/angular/demo6">Preview</a>',
        ],
        'update': [
          'Update Angular version to <code>13</code>. <a href="https://blog.angular.io/angular-v13-is-now-available-cce66f7bc296">https://blog.angular.io/angular-v13-is-now-available-cce66f7bc296</a>',
          'Update and sync core assets from the HTML version.',
          'Moved angular vendor style files into separate file',
        ],
        'fix': [
          'Fix .gitignore file',
        ],
    ...
    },
    {
      ...
      'changelog': {
        'new': [
          'Added new Angular <code>demo2</code>. <a href="https://preview.keenthemes.com/metronic8/angular/demo2">Preview</a>',
          'Added new Angular <code>demo3</code>. <a href="https://preview.keenthemes.com/metronic8/angular/demo3">Preview</a>',
        ],
        'update': [
          'Update and sync core assets from the HTML version.'
        ],

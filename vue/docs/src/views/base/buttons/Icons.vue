<template>
  ...
  <div class="pt-10">
    ...
    <div class="py-5">
      Use
      <a href="#" class="fw-bold">Duotune Svg Icons</a>&nbsp;in combination with
      ...
      <div class="rounded border p-10">
        <template v-for="(item, i) in colors" :key="i">
          <a href="#" :class="`btn-${item}`" class="btn me-2 mb-2">
            <span class="svg-icon svg-icon-2">
              <inline-svg src="media/icons/duotune/graphs/gra004.svg" /> </span
            >Caption
          </a>
        </template>
        ...
        <template v-for="(item, i) in colors" :key="i">
          <a href="#" :class="`btn-${item}`" class="btn btn-icon me-2 mb-2">
            <span class="svg-icon svg-icon-2">
              <inline-svg src="media/icons/duotune/graphs/gra004.svg" />
            </span>
          </a>
        </template>
      </div>
    ...
    <div class="py-5">
      Use
      <a href="#" class="fw-bold">Font Awesome Icons</a>&nbsp;in combination
    ...
    <div class="py-5">
      Use
      <a href="#" class="fw-bold">Line Awesome Icons</a>&nbsp;in combination
      with buttons as shown below:
    </div>
    <!--end::Block-->
